...
export interface Vehicle { 
    ...
    vehicleStatusD?: Vehicle.VehicleStatusDEnum;
...
export namespace Vehicle {
    ...
    export type VehicleStatusDEnum = 'PENDING' | 'APPROVED' | 'REJECTED';
    export const VehicleStatusDEnum = {
        Pending: 'PENDING' as VehicleStatusDEnum,
        Approved: 'APPROVED' as VehicleStatusDEnum,
        Rejected: 'REJECTED' as VehicleStatusDEnum
    };
